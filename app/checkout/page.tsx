...
import PaymentPopup from "../components/checkout/Payment";
          ...
          <div className="space-y-6 lg:col-span-7 xl:col-span-8">
            ...
            <section className="space-y-3">
              <div className="flex justify-between items-end">
                ...
                <button className="text-sm font-semibold text-gray-900 hover:text-blue-700 transition">
                  Change
                </button>
              </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 lg:p-5 flex items-center justify-between animate-in fade-in slide-in-from-top-2 duration-300">
                  <div className="flex items-center gap-4">
                    <div className="bg-white px-2 py-1 rounded border border-gray-200">
                      <span className="text-blue-700 font-black text-sm italic tracking-tighter">
                        BCA
                      </span>
                    </div>
