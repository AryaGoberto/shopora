...
export default function BankTransferPage() {
  ...
  const bankOptions = [
    { id: 'bca', ...BANK_ACCOUNTS.bca, va: '7891234567890' },
    { id: 'mandiri', ...BANK_ACCOUNTS.mandiri, va: '1234567890123' },
    { id: 'bri', ...BANK_ACCOUNTS.bri, va: '9876543210987' },
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-4 md:px-20 py-10 max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Transfer Bank</h1>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-8">
          ...
          <h2 className="text-4xl font-bold text-[#1230AE] mt-2">{formatIDR(amount)}</h2>
            ...
            >
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-900">
                  <strong>Instruksi:</strong> Buka aplikasi banking Anda, transfer ke nomor Virtual Account di atas sesuai jumlah yang tertera.
                </p>
              </div>
            </div>
          ))}
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200">
          ...
          <button
            ...
            className="w-full bg-[#1230AE] text-white font-bold py-4 rounded-xl hover:bg-blue-800 transition"
          >
